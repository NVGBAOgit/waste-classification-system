    ...
    try:
        ...
        if df.empty:
            ...
            with c2:
                ...
                fig2.update_traces(hovertemplate='<b>%{x}</b><br>Số lượng: %{y}<extra></extra>')
            ...
            with filter_col1:
                filter_opts = ["Tất cả", "Tái Chế", "Hữu Cơ", "Nguy Hại", "Vô Cơ"]
                selected_category = st.selectbox("📁 Lọc theo Thùng rác:", filter_opts)
