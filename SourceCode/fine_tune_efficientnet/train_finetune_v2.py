...
from data_loader_finetune_v2 import train_loader, val_loader, class_weights, NUM_CLASSES
...
def train_finetune():
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            save_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'saved_models', 'efficientnet_finetune_best_v2.pth'))
